...
void vp9_highbd_iht16x16_256_add_sse4_1(const tran_low_t *input, uint16_t *output, int pitch, int tx_type, int bd);
RTCD_EXTERN void (*vp9_highbd_iht16x16_256_add)(const tran_low_t *input, uint16_t *output, int pitch, int tx_type, int bd);
